!function(e, t) {
                ...
                _ = h ? (a = e, l = i, c = s, function i(s) {
                    ...
                    for (let t = s["target"]; t && t !== this; t = t.parentNode)
                        for (let e = n.length; e--;)
                            if (n[e] === t)
                                return s.delegateTarget = t, i.oneOff && b.off(a, s.type, l, c), c.apply(t, [s]);
                    return null
    ...
    class g extends t {
        ...
        {
            e || (this._isPaused = !0),
            f.findOne(".carousel-item-next, .carousel-item-prev", this._element) && (B(this._element), this.cycle(!0)),
        ...
        _addEventListeners()
        {
            ...
            "hover" === this._config.pause && (b.on(this._element, "mouseenter.bs.carousel", e => this.pause(e)), b.on(this._element, "mouseleave.bs.carousel", e => this.cycle(e))),
    ...
    b.on(document, "click.bs.collapse.data-api", '[data-bs-toggle="collapse"]', function(e) {
        ...
        f.find(t).forEach(e => {
            ...
            let i;
            i = t ? (null === t._parent && "string" == typeof s.parent && (t._config.parent = s.parent, t._parent = t._getParent()), "toggle") : s,
    ...
    function Se(e) {
        for (var t, i = y(e), s = De(e); s && (t = s, 0 <= ["table", "td", "th"].indexOf(v(t))) && "static" === A(s).position;)
            s = De(s);
        ...
        rt = {
            ...
            fn: function(e) {
                var r = e.state,
                    ...
                    s = i.x,
                    i = i.y;
                null != r.modifiersData.popperOffsets && (r.modifiersData.popperOffsets.x += s, r.modifiersData.popperOffsets.y += i),
                r.modifiersData[e] = t
            }
        },
        at = {
                        ...
                        if (!f) {
                            ...
                            if (ht(t, e)) {
                                ...
                                for (var i, s, n, o = 0; o < u.orderedModifiers.length; o++)
                                    !0 !== u.reset ? (i = (n = u.orderedModifiers[o]).fn, s = n.options, n = n.name, "function" == typeof i && (u = i({
                                        state: u,
                                        options: void 0 === s ? {} : s,
                                        name: n,
                                        instance: p
    ...
    class C extends t {
        ...
        _getConfig(e)
        {
            if (e = {
                ...
                ...h.getDataAttributes(this._element),
                ...e
            }, i("dropdown", e, this.constructor.DefaultType), "object" != typeof e.reference || r(e.reference) || "function" == typeof e.reference.getBoundingClientRect)
                return e;
    ...
    class M extends t {
        ...
        _enter(e, t)
        {
            ...
            t.getTipElement().classList.contains("show") || "show" === t._hoverState ? t._hoverState = "show" : (clearTimeout(t._timeout), t._hoverState = "show", t._config.delay && t._config.delay.show ? t._timeout = setTimeout(() => {
